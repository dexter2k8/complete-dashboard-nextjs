...
function Team() {
  ...
  return (
    <>
      ...
      <div
        className={`rounded overflow-hidden h-[calc(100vh-18rem)] [&_.MuiDataGrid-row]:cursor-default [&_.MuiDataGrid-root]:border-none [&_.MuiDataGrid-columnHeaders]:border-none [&_.MuiDataGrid-footerContainer]:border-none [&_.MuiDataGrid-cell:focus]:outline-none ${
          isDark
      ...
      >
        <DataGrid
          ...
          onRowClick={(e) => console.log(`row ${e.id}`)}
        />
      </div>
